...
# Create a dictionary of the performance metrics
metrics = {
...
# Create a bar graph for the metrics
plt.figure(figsize=(8, 5))
plt.bar(metrics_df['Metrics'], metrics_df['Score'])
plt.xlabel('Metrics')
plt.ylabel('Score')
plt.title('Locus For Local Retailers')
...
def chat():
    ...
    elif input_text.lower() in greeting_keywords:
...
if __name__ == '__main__':
    app.run(debug=False, port=5001)  # Change the port number to an available on